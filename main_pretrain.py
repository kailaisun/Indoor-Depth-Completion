...
def get_args_parser():
    ...
    parser.add_argument('--input_size', default=224, type=int,
                        help='images input size') #matterport 256x320 original 224x224
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/mnt/yangzhou/dataset/matterport/npy/train', type=str,
                        help='dataset path')

    parser.add_argument('--output_dir', default='/mnt/yangzhou/random_224_75_4_0',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/mnt/yangzhou/random_224_75_4_0',
